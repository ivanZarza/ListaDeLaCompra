...
def get_tipos():
    try:
        ...
        tipos = cursor.fetchall()  # Obtiene todos los resultados como lista de diccionarios
        # Si no hay resultados, retorna 404
        if not tipos:
            return {'message': 'No se encontraron tipos de ingredientes'}, 404
        # Ahora tipos ya es una lista de diccionarios, por ejemplo [{'tipo': 'Fruta'}, {'tipo': 'Verdura'}]
        return tipos, 200  # Retorna la lista y el código de estado

        # --- MÉTODO ANTERIOR CON TUPLAS ---
